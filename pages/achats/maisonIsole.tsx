...
const AchatIsole: NextPage = () => {
  return (
    <div className={styles.container}>
      <Head>
        <title>ORTHIMMO - Maison Isolée</title>
      </Head>
      ...
      <Title className=" text-5xl mb-6 text-[#C2AD74] font-bold">
        MAISON ISOLEE EN FORET
      </Title>
      <Title />
      <Image
        className=" rounded-[50px] bg-center"
        priority
        src="/image/achats/maison3.jpg"
        objectFit="cover"
        width={1100}
        height={600}
        alt="houses"
      ...
      <Description>
        <Details>
          ...
          <Dimension>170 m2</Dimension>
          <City>Bordeaux</City>
          <Price>Prix : 150 000€</Price>
