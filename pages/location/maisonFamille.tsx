...
const LocationMaisonFamille: NextPage = () => {
  return (
    <div className={styles.container}>
      <Head>
        <title>ORTHIMMO - Maison famille</title>
      </Head>
      ...
      <Image
        ...
        priority
        src="/image/locations/maison1.jpg"
        objectFit="cover"
        width={1100}
        height={600}
        alt="houses"
      ...
      <Description>
        <Details>
          ...
          <Dimension>120 m2</Dimension>
          <City>Lyon</City>
          <Price>Prix : 1 500€</Price>
...
export default LocationMaisonFamille;
