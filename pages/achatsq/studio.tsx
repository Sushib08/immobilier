...
const AchatStudio: NextPage = () => {
  return (
    <div className={styles.container}>
      <Head>
        <title>ORTHIMMO - Studio mignon</title>
      </Head>
      ...
      <Description>
        <Details>
          ...
          <Dimension>30 m2</Dimension>
          <City>Toulon</City>
          <Price>Prix : 180 000€</Price>
