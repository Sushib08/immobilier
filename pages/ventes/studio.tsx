...
const VentesStudio: NextPage = () => {
  return (
    <div className={styles.container}>
      <Head>
        <title>ORTHIMMO - Studio</title>
      </Head>
      ...
      <Title className=" text-5xl mb-6 text-[#C2AD74] font-bold">
        STUDIO AU BORD DE MER
      </Title>
      <Title />
      <Image
        className=" rounded-[50px] bg-center"
        priority
        src="/image/ventes/studio1.jpg"
        objectFit="cover"
        width={1100}
        height={600}
        alt="houses"
