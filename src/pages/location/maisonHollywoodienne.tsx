...
const LocationMaisonHollywoodienne: NextPage = () => {
  return (
    <div className={styles.container}>
      <Head>
        <title>ORTHIMMO - Maison Hollywoodienne</title>
      </Head>
      ...
      <Title className=" text-5xl mb-6 text-[#C2AD74] font-bold">
        MAISON STYLE HOLLYWOODIEN
      </Title>
      <Title />
      <Image
        className=" rounded-[50px] bg-center"
        priority
        src="/image/locations/maison4.jpg"
        objectFit="cover"
        width={1100}
        height={600}
        alt="houses"
...
export default LocationMaisonHollywoodienne;
