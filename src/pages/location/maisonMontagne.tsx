...
const LocationMaisonMontagne: NextPage = () => {
  return (
    <div className={styles.container}>
      <Head>
        <title>ORTHIMMO - Maison Montagne</title>
      </Head>
      ...
      <Image
        ...
        priority
        src="/image/locations/maison3.jpg"
        objectFit="cover"
        width={1100}
        height={600}
        alt="houses"
      ...
      <Description>
        <Details>
          ...
          <Dimension>110 m2</Dimension>
          <City>Bordeaux</City>
          <Price>Prix : 1 000€</Price>
...
export default LocationMaisonMontagne;
