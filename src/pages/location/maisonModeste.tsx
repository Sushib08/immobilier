...
const LocationMaisonModeste: NextPage = () => {
  return (
    <div className={styles.container}>
      <Head>
        <title>ORTHIMMO - Maison Modeste</title>
      </Head>
      ...
      <Image
        ...
        priority
        src="/image/locations/maison2.jpg"
        objectFit="cover"
        width={1100}
        height={600}
        alt="houses"
...
export default LocationMaisonModeste;
