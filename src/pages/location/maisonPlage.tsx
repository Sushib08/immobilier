...
const LocationsMaisonPlage: NextPage = () => {
  return (
    <div className={styles.container}>
      <Head>
        <title>ORTHIMMO - Maison plage</title>
      </Head>
      ...
      <Image
        ...
        priority
        src="/image/locations/maison6.jpg"
        objectFit="cover"
        width={1100}
        height={600}
        alt="houses"
...
export default LocationsMaisonPlage;
