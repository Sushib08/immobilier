...
const VentesMaisonAgreable: NextPage = () => {
  return (
    <div className={styles.container}>
      <Head>
        <title>ORTHIMMO - Maison agréable</title>
      </Head>
...
export default VentesMaisonAgreable;
