...
const VentesMaisonCalifornienne: NextPage = () => {
  return (
    <div className={styles.container}>
      <Head>
        <title>ORTHIMMO - Maison Californienne</title>
      </Head>
      ...
      <Title className=" text-5xl mb-6 text-[#C2AD74] font-bold">
        MAISON STYLE CALIFORNIENNE
      </Title>
      <Title />
      <Image
        className=" rounded-[50px] bg-center"
        priority
        src="/image/ventes/maison3.jpg"
        objectFit="cover"
        width={1100}
        height={600}
        alt="houses"
...
export default VentesMaisonCalifornienne;
